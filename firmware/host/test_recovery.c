...
E87_TEST(normal_boot_disarms_then_arms_exactly_16_not_8)
{
    ...
    E87_ASSERT_EQ_U32(UINT32_C(16), E87_PB08_RESET_HOLD_SECONDS);
    ...
    E87_ASSERT_EQ_U32(E87_RECOVERY_COMMAND_DISARM_PB08_RESET,
                      sink.commands[sink.step_start]);
    E87_ASSERT_EQ_U32(E87_RECOVERY_COMMAND_ARM_PB08_RESET_16S,
